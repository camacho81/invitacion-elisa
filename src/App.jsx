...
import { CheckCircle, ArrowRight, ShieldAlert, Database, Table, ArrowLeft, Loader2, Utensils, Lock, Flower, Calendar, Clock, MapPin, Heart, Download, Phone, Map } from 'lucide-react';
        ...
        <div className="w-full md:w-1/2 bg-[#FFFCFD] rounded-sm shadow-xl p-8 lg:p-12 relative overflow-hidden flex flex-col items-center text-center">
          ...
          <div className="relative z-10 flex flex-col items-center w-full">
            ...
            <p className="text-slate-500 italic font-serif text-lg sm:text-xl mb-10 px-4">
              "¡Me encantaría que me acompañaras en este día tan importante para mí!"
            </p>
            ...
            <div className="space-y-6 w-full">
              ...
              <div className="flex flex-col items-center">
                ...
                {/* Botón de Mapa - Ceremonia */}
                <a href="https://maps.app.goo.gl/6HwSPVxjEgQCFf4S9" target="_blank" rel="noreferrer" className="mt-2 flex items-center gap-1.5 px-3 py-1 bg-pink-50 text-pink-500 rounded-full text-[10px] uppercase tracking-wider font-semibold hover:bg-pink-100 hover:text-pink-600 transition-colors">
              ...
              <div className="flex flex-col items-center relative">
                ...
                {/* Botón de Mapa - Celebración */}
                <a href="https://maps.app.goo.gl/3DozLHi2mf3CggP9A" target="_blank" rel="noreferrer" className="mt-3 relative z-10 flex items-center gap-1.5 px-3 py-1 bg-pink-50 text-pink-500 rounded-full text-[10px] uppercase tracking-wider font-semibold hover:bg-pink-100 hover:text-pink-600 transition-colors">
                  <Map size={12} /> Ver en el mapa
                </a>
              </div>
              ...
              <div className="flex flex-col items-center w-full">
                <div className="flex items-center gap-2 text-pink-400 font-bold text-[10px] sm:text-xs tracking-widest uppercase mb-4">
                  <Phone size={14} strokeWidth={2.5} /> Teléfonos de contacto
                </div>
                
                <div className="flex flex-row gap-8 justify-center w-full">
                  <div className="flex flex-col items-center">
                    <p className="text-slate-400 text-[10px] uppercase tracking-wider mb-1 font-semibold">Paco</p>
                    <a href="tel:+34609045984" className="text-slate-600 font-medium hover:text-pink-500 transition-colors bg-white/50 px-3 py-1 rounded-lg">
                      609 045 984
                    </a>
                  </div>

                  <div className="flex flex-col items-center">
                    <p className="text-slate-400 text-[10px] uppercase tracking-wider mb-1 font-semibold">Elisa</p>
                    <a href="tel:+34607464483" className="text-slate-600 font-medium hover:text-pink-500 transition-colors bg-white/50 px-3 py-1 rounded-lg">
                      607 464 483
                    </a>
                  </div>
                </div>
